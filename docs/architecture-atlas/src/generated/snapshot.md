...
| Historical audits, plans, and review evidence | 251 | [open](inventory/historical.md) |
| Project metadata and local development definitions | 22 | [open](inventory/project-meta.md) |
| Vendored upstream files | 706 | [open](inventory/vendor.md) |

> A dirty snapshot is useful for development navigation but is not a reproducible release baseline.
