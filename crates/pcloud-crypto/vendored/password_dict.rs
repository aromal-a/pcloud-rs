// AUTO-GENERATED from pclsync/ppassworddict.h. Do not edit.
#[allow(clippy::large_stack_arrays, clippy::large_const_arrays)]
pub(crate) static PASSWORD_DICT: [[u8; 8]; 8525] = [
